...
describe('Text', function() {
  ...
  describe('namedEntities', function() {
    it('should get the right response format', function(done) {

      var text = "A year ago, the New York Times published confidential comments about ISIS' ideology by Major General Michael K. Nagata, then U.S. Special Operations commander in the Middle East.";
      indico.namedEntities([text, text])
        .then(function(res) {
          console.log(res[0]);
          res[0].should.have.keys('people', 'places', 'organizations')
          res[1].should.have.keys('people', 'places', 'organizations')
          done();
        })
        .catch(function(err){
            done(err);
